          ...
          <div className="w-full">
            <div>
              <div className="flex items-center gap-2 group cursor-pointer p-2">
                ...
                />
                <strong className="flex-1 text-gray-400 text-xs group-hover:text-gray-200">
                  TEXT CHANNELS
                </strong>
              ...
              <div className="w-full">
                ...
                <div className="flex p-2">
                  ...
                  <div className="flex flex-col ml-4">
                    ...
                    <p className="text-gray-100 font-light text-sm">Opa tudo bem?</p>
                  </div>
                </div>
                <div className="flex p-2">
                  <div className="min-w-max mt-2">
                ...
                <div className="flex p-2">
                  ...
                  <div className="flex flex-col ml-4">
                    ...
                    <p className="text-gray-100 font-light text-sm">Lorem ipsum dolor sit amet consectetur, adipisicing elit. At error necessitatibus deleniti temporibus voluptatum itaque repellat molestiae ratione quod quas, reprehenderit ex iste laudantium sit vitae debitis aut commodi tenetur?</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-60 bg-sidebar2 border-t-2 border-zinc-800">
            <div className="p-2">
              ...
              <div className="flex p-2 items-center hover:bg-zinc-600 rounded-md transition-colors cursor-pointer">
                ...
                <div className="flex flex-col flex-1 ml-4">
                  <strong className="text-gray-400 font-medium max-w-max">
                    kalyan
                  </strong>
                </div>
              </div>
              <div className="flex p-2 items-center hover:bg-zinc-600 rounded-md transition-colors cursor-pointer">
                ...
                <div className="flex flex-col flex-1 ml-4">
                  <strong className="text-gray-400 font-medium max-w-max cursor-pointer">
                    elros
                  </strong>
                </div>
              </div>
